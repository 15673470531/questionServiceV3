...
<!--            <li class="layui-nav-item"><a href="./recharge.php">充值/开会员</a></li>-->
    ...
    <div class="layui-container gq-height-73 layui-col-md12 layui-col-xs12 layui-col-sm12 layui-col-lg12" style="width: 100%">
                ...
                <div class="layui-row layui-col-md12 layui-col-xs12 layui-col-sm12">
                    <div class="layui-input-group layui-col-md12 layui-col-xs12 layui-col-sm12">
                        ...
                        <div class="layui-input-suffix" style="width: 0;height: 34px;line-height: 34px;padding: 0px 0px 0px 10px;">
                            <button id="questionCommit" type="submit" class="layui-btn layui-btn-primary gq-height-100" style="border-radius: 5px;font-size: 16px" onclick="commit()">发送</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    window.location.href = './chatGpt2.php';
    checkingLoginStatus();
    ...
    function getNewVersionHtml(msg){
        let str = '';
        str += '<div style="color: red" class="gq-msg-time"><a style="color: blue" href="./chatGpt2.php">'+msg+'</a></div>';
        return str;
    }
